                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('images/image.webp')}}" alt="Image"
                                                                            title="Image"
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello, {{ $student->name }}</span>
                                                                </p>
                                                                <p
                                                                    style="font-size: 14px; line-height: 140%; margin: 0px;">
                                                                    &nbsp;</p>
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        reset your password, here is your OTP code </span></p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div align="left">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:51Fpx; v-text-anchor:middle; width:205px;" arcsize="2%"  stroke="f" fillcolor="#18163a"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                                                <a href="" target="_blank" class="v-button"
                                                                    style="box-sizing: border-box; display: inline-block; text-decoration: none; text-size-adjust: none; text-align: center; color: rgb(255, 255, 255); background: rgb(24, 22, 58); border-radius: 1px; width: auto; max-width: 100%; word-break: break-word; overflow-wrap: break-word; font-size: 14px; line-height: inherit;"><span
                                                                        style="display:block;padding:15px 40px;line-height:120%;"><span
                                                                            style="font-size: 18px; line-height: 21.6px;"> <p>Your OTP for password reset is: <strong>{{ $otp }}</strong></p>
                                                                            <p>This OTP will expire in 1 minute.</p></span></span>
                                                                </a>
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td valign="middle"
                                                                                    ...
                                                                                    <a href=" " title="Facebook"
                                                                                        target="_blank"
                                                                                        style="color: rgb(22, 26, 57); text-decoration: underline; line-height: inherit;"><img
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 10px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p
                                                                    style="line-height: 140%; font-size: 14px; margin: 0px;">
                                                                    <span
